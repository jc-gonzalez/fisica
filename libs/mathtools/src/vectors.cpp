...
bool vector3d::isEqualTo(const vector3d& other, const double tolerance) const
{
...
vector3d& vector3d::set(const double nx, const double ny, const double nz)
{X=nx; Y=ny; Z=nz; return *this;}
vector3d& vector3d::set(const vector3d& p)
{X=p.X; Y=p.Y; Z=p.Z;return *this;}

double vector3d::norm2() const { return X*X + Y*Y + Z*Z; }
double vector3d::norm() const { return sqrt(norm2()); }

double vector3d::length2() const { return norm2(); }
double vector3d::length() const { return norm(); }

double vector3d::dot(const vector3d& other) const
{ return X*other.X + Y*other.Y + Z*other.Z; }

double vector3d::distanceFrom(const vector3d& other) const
{ return vector3d(X - other.X, Y - other.Y, Z - other.Z).length(); }

double vector3d::distanceFrom2(const vector3d& other) const
...
vector3d& vector3d::setLength(double newlength)
{ normalize(); return (*this *= newlength); }

vector3d& vector3d::invert()
{ X *= -1, Y *= -1, Z *= -1; return *this; }

void vector3d::rotateXZBy(double degrees, const vector3d& center)
{
    degrees = d2r(degrees);
...
void vector3d::rotateXYBy(double degrees, const vector3d& center)
{
    degrees = d2r(degrees);
    double cs = cos(degrees);
    double sn = sin(degrees);
...
void vector3d::rotateYZBy(double degrees, const vector3d& center)
{
    degrees = d2r(degrees);
    double cs = cos(degrees);
    double sn = sin(degrees);
...
vector3d vector3d::interpolate(const vector3d& other, double d) const
{
    const double inv = 1.0 - d;
    return vector3d((double)(other.X*inv + X*d), (double)(other.Y*inv + Y*d), (double)(other.Z*inv + Z*d));
}

vector3d vector3d::interpolate_quadratic(const vector3d& v2, const vector3d& v3, double d) const
{
...
vector3d& vector3d::interpolate(const vector3d& a, const vector3d& b, double d)
{
...
vector3d vector3d::horizontalAngle() const
{
    vector3d angle;
...
vector3d vector3d::sphericalCoordinateAngles() const
{
    vector3d angle;
...
void vector3d::as4Values(double* array) const {
    array[0] = X;
    array[1] = Y;
    array[2] = Z;
    array[3] = 0;
...
void vector3d::as3Values(double* array) const {
    array[0] = X;
    array[1] = Y;
    array[2] = Z;
}
