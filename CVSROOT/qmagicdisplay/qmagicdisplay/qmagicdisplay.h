...
#ifndef QMAGICDISPLAY_H
#define QMAGICDISPLAY_H
...
void statusCallback(int id_);
  ...
  /** the file to read will be a DAT file */
  void slotOptReadDAT();
  /** the file to read will be a PHE file */
  void slotOptReadPHE();
  /** the file to read will be a RFL file */
  void slotOptReadRFL();
