...
#ifndef EXTENDEDREFLECTOR_H
#define EXTENDEDREFLECTOR_H
...
//======================================================================
// Class: ExtendedReflector
//======================================================================
class ExtendedReflector : public Reflector {
public:
    ExtendedReflector();
    ~ExtendedReflector();
...
private:
    ...
    double ct_Elem_length;
    double ct_Elem_width;
    ...
    double ** mirrorInfo;
    int nMirrorInfo;
    std::vector<RingData> ringFocals;
};


#endif  /* EXTENDEDREFLECTOR_H */
