...
// Constructor
//------------------------------------------------------------
CameraSqPix::CameraSqPix(int npix, double wid, int nring1, int nring2)
    : ct_NPixels(npix),
      ct_PixelWidth(wid),
...
//------------------------------------------------------------
void CameraSqPix::read_pixels(void)
{
...
// @date Fri Mar 12 16:33:34 MET 1999
//------------------------------------------------------------
void CameraSqPix::create_pixels(void)
{
...
// @date
//------------------------------------------------------------
int CameraSqPix::pixel_id(double x, double y)
{
    static int ki, kj, kk;
    static int n;
    static int j;
...
//------------------------------------------------------------
bool CameraSqPix::pixels_are_neig(int pix1, int pix2)
{
...
//------------------------------------------------------------
int CameraSqPix::pixel_bit_mask(int i, double q0, Histogram<double> **d, int b)
{
...
// @date
//------------------------------------------------------------
void CameraSqPix::coord2hex(double cx, double cy, int &ki, int &kj, int &kk)
{
    double dx, dy, dz;
    double rx, ry, rz;
    double ax, ay, az;
...
// @date
//------------------------------------------------------------
void CameraSqPix::hex2coord(int ki, int kj, int kk, double &x, double &y)
{
...
// @date
//------------------------------------------------------------
void CameraSqPix::ijk2xy(double ki, double kj, double kk,
                       double &x, double &y)
{
    static const double unit = ct_PixelWidth_corner_2_corner_half;
...
// @date
//------------------------------------------------------------
void CameraSqPix::xy2ijk(double cx, double cy,
