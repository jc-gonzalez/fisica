...
void QGraceApp::initDoc()
{
   doc=new QGraceDoc();
}

void QGraceApp::initView()
{
  ////////////////////////////////////////////////////////////////////
  // set the main widget here
  view=new QGraceView(this, doc);
  setCentralWidget(view);
}

bool QGraceApp::queryExit()
{
...
void QGraceApp::slotViewToolBar(bool toggle)
{
...
void QGraceApp::slotViewStatusBar(bool toggle)
{
...
void QGraceApp::slotHelpAbout()
{
  QMessageBox::about(this,tr("About..."),
                      tr("QGrace\nVersion " VERSION "\n(c) 2001 by J C Gonzalez") );
}
