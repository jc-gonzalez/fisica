...
main(int argc, char **argv)
{
  ...
  int   i, j, k, m;           //@< simple counters
  float x;                    //@< intermediate variables
  ...
  int   noverq0;              //@< number of pixels above threshold
  ...
  **/
  ...
  for (i=0; i<ct_NPixels; ++i) {
    sprintf(htimename,"Discriminator signal for pixel #%d", i+1);
