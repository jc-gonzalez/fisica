...
main(int argc, char **argv) 
{
  ...
  */
  ...
  // generate parallel beam if requeste in input file

  generate_parallel_beam_if_needed(evth);
...
//!@{ 
void
log(const char *funct, const char *fmt, ...)
{
  va_list args;
...
//!@{ 
void
logerr(const char *funct, const char *fmt, ...)
{
  va_list args;
...
//!@{ 
void
error(const char *funct, const char *fmt, ...)
{
  va_list args;
...
//!@{ 
void
generate_parallel_beam_if_needed(COREventHeader & evth)
{
  CORParticle photon;         //@< Particle (photon) class (from CORSIKA)
  CORStatfile stat;           //@< Statistics file class (from CORSIKA)
