...
const T Histogram<T>::get_median(void)
{
  ...
  T * first = data.begin();               // iterator, runs over the data
  T * last  = data.end();                 // iterator, end of data
...
/*
 *$Log$
 * Revision 1.2  2000/05/29  16:01:32  gonzalez
 * *** empty log message ***
 *
 * Revision 1.1.1.1  2000/03/22  15:25:11  gonzalez
 * Imported sources
 *
 * Revision 1.4  1999/12/03  17:18:23  gonzalez
 * *** empty log message ***
 *
 *
 */
